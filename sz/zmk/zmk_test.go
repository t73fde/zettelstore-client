...
func TestHeading(t *testing.T) {
	...
	checkTcs(t, testCases{
		...
		{"=== h{id=abc}", "(BLOCK (HEADING ((\"id\" . \"abc\")) 1 (TEXT \"h\")))"},
...
func TestTable(t *testing.T) {
	...
	checkTcs(t, testCases{
		...
		{"| |", "(BLOCK (TABLE () () (ROW () (CELL ()))))"},
		{"|||", "(BLOCK (TABLE () () (ROW () (CELL ()) (CELL ()))))"},
		{"|a", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")))))"},
		{"| a", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")))))"},
		{"|a|", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")))))"},
		{"|a| ", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")) (CELL ()))))"},
		{"|a|b", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")) (CELL () (TEXT \"b\")))))"},
		{"|a|b|", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")) (CELL () (TEXT \"b\")))))"},
		{"|a\n|b", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\"))) (ROW () (CELL () (TEXT \"b\")))))"},
		{"|a|b\n|c|d", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")) (CELL () (TEXT \"b\"))) (ROW () (CELL () (TEXT \"c\")) (CELL () (TEXT \"d\")))))"},
		{"|a\n|\n|b", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\"))) (ROW () (CELL ())) (ROW () (CELL () (TEXT \"b\")))))"},
		{"|a\n|\n|", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\"))) (ROW () (CELL ())) (ROW () (CELL ()))))"},
		{"|%", "(BLOCK)"},
		{"|=a", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\")))))"},
		{"|= a", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\")))))"},
		{"|=< a", "(BLOCK (TABLE () (ROW () (CELL ((align . \"left\")) (TEXT \"a\")))))"},
		{"|= <a", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"<a\")))))"},
		{"|=a\n|b", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\"))) (ROW () (CELL () (TEXT \"b\")))))"},
		{"|=a|\n|b|", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\"))) (ROW () (CELL () (TEXT \"b\")))))"},
		{"|a|b\n|%---\n|c|d", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")) (CELL () (TEXT \"b\"))) (ROW () (CELL () (TEXT \"c\")) (CELL () (TEXT \"d\")))))"},
		{"|a|b\n|c", "(BLOCK (TABLE () () (ROW () (CELL () (TEXT \"a\")) (CELL () (TEXT \"b\"))) (ROW () (CELL () (TEXT \"c\")) (CELL ()))))"},
		{"|=<a>\n|b|c", "(BLOCK (TABLE () (ROW () (CELL ((align . \"left\")) (TEXT \"a\")) (CELL ())) (ROW () (CELL ((align . \"right\")) (TEXT \"b\")) (CELL () (TEXT \"c\")))))"},
		{"|=<a|=b>\n||", "(BLOCK (TABLE () (ROW () (CELL ((align . \"left\")) (TEXT \"a\")) (CELL ((align . \"right\")) (TEXT \"b\"))) (ROW () (CELL ()) (CELL ((align . \"right\"))))))"},
		{"|=a\n|:b", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\"))) (ROW () (CELL ((align . \"center\")) (TEXT \"b\")))))"},
		{"|=a\n|: b", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\"))) (ROW () (CELL ((align . \"center\")) (TEXT \"b\")))))"},
		{"|=a\n|:b|:c", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\")) (CELL ())) (ROW () (CELL ((align . \"center\")) (TEXT \"b\")) (CELL ((align . \"center\")) (TEXT \"c\")))))"},
		{"|=a\n|: b|: c", "(BLOCK (TABLE () (ROW () (CELL () (TEXT \"a\")) (CELL ())) (ROW () (CELL ((align . \"center\")) (TEXT \"b\")) (CELL ((align . \"center\")) (TEXT \"c\")))))"},
		{"|=a <\n|:b", "(BLOCK (TABLE () (ROW () (CELL ((align . \"left\")) (TEXT \"a\"))) (ROW () (CELL ((align . \"center\")) (TEXT \"b\")))))"},
		{"|=a <\n|: b", "(BLOCK (TABLE () (ROW () (CELL ((align . \"left\")) (TEXT \"a\"))) (ROW () (CELL ((align . \"center\")) (TEXT \"b\")))))"},
	})
}
